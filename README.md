...
local Window = OrionLib:MakeWindow({IntroText = "Script Made By Vargaxs",IntroIcon = "rbxassetid://7733955511",Name = ("Vargxs Hub • "..GameName.." ✓ Executor "..executor),IntroToggleIcon = "rbxassetid://4335489011",HidePremium = false,SaveConfig = false,IntroEnabled = true,ConfigFolder = "Mm2SHub"})
